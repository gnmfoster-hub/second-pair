...
export function AssistantForm({ studio }: { studio: Studio }) {
  const [state, action] = useActionState<FormState, FormData>(updateAssistant, {});
    ...
    <form action={action} className="space-y-8">
      <section className="card space-y-5 p-6">
        <div>
          ...
          <p className="hint mt-1">
            How the assistant sounds. Be specific — &ldquo;friendly and professional&rdquo;
            describes every business on earth.
          </p>
        </div>
      ...
      <section className="card space-y-5 p-6">
        <div>
          ...
          <p className="hint mt-1">
            One per line. These go straight into the assistant&rsquo;s instructions. It
            cannot use them to break a safety rule — it will still never quote under your
            minimum, never claim to be human, and never book someone underage.
          </p>
        </div>
        ...
        >
          <textarea
            ...
            rows={4}
            className="input"
            placeholder={"Parking is free after 6pm\nWe're on the first floor, there's a lift\nWe can do evenings if asked"}
          />
        </Field>

        <Field
          label="Never say"
          hint="Hard don'ts, in your words."
        >
          <textarea
            name="never_mention"
        ...
        >
          <textarea
            ...
            rows={3}
            className="input"
            placeholder={"Anything to do with weddings\nAnyone asking about a refund\nJobs over £2,000"}
          />
        </Field>
      </section>
      ...
      <section className="card space-y-5 p-6">
        <div>
          ...
          <p className="hint mt-1">
            The most useful thing on this page. Put in a question you actually get, and the
            reply you would have typed yourself. Two or three is plenty — the assistant
            picks up your length and your words from them, and does not copy them as
            scripts.
          </p>
        </div>
